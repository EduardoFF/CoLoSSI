...
class agent_info():
    ...
    def Generate_bid(self, task, bidding, work, sch, time, pa): 
        self.bid = 0     
        ...
        val += sch * len(self.schedule) + time * sum(self.timings) + pa * path_length
    ...
    for k in range(len(Data.CELLS)):
        ...
        for ag in AGENT_OBJ:
            ...
            for task in All_Tasks:
                bid = ag.Generate_bid(task, bidding, work, sch, time, pa)
...
if __name__ == "__main__":
    ...
    for i in range(20):
        ...
        for ag in AGENT_OBJ:
            ...
            Change_inschedule_task_timings(ag, Tasks_Left, Tasks_Timings, math.ceil(current_maximum * 1.12) )
    ...
    for i in range(20):
        ...
        for ag in AGENT_OBJ:
            Tasks_Left = get_task_left()
            Change_inschedule_task_timings(ag, Tasks_Left, Tasks_Timings, math.ceil(max(times) * 2.70))
            test2.append(sum(ag.timings))
    ...
    print("Timing checker test 1 ::::::: " + str([x < 0.0601 for x in TIMES2] == [True] * len(Data.CELLS))+"\n")
    print(":::::::::::::::::Agents timing checker ::::::: ",end = " ")
    ...
    print("\nTimings checker test 2 ::::::: " + str([x < 0.0601 for x in TIMES2] == [True] * len(Data.CELLS))+"\n")
    print(":::::::::::::::::Agents timing checker ::::::: ", end = " ")
    ...
    for ag in AGENT_OBJ:
        print(f"Agent {ag.ID}")
        sch.append(ag.schedule)
        tim.append(ag.timings)
        print("Path: ", ag.schedule)
        print("Time Alloc ", ag.timings)
